...
import {
  useUpdateUserRole,
  useUpdateUserStatus,
} from "@/hooks/supabase/use-profile";
import type {
  Profile,
  UserRoleType,
  UserStatusType,
...
export function UsersDataTable({
  ...
  const handleChangeRole = async (userId: string, role: UserRoleType) => {
    await updateRole({ userId, role });
  };

  const handleChangeStatus = async (userId: string, status: UserStatusType) => {
  ...
  const columns = createColumns(handleChangeRole, handleChangeStatus);
